...
class ReturnToMenuButton(arcade.gui.UIGhostFlatButton):
    ...
    def __init__(self, center_x, center_y, endgame, UImanager, stop_song):
        super().__init__(
            'Return to Menu',
            center_x=center_x,
            center_y=center_y,
    ...
    def on_click(self):
        ...
        self.endgame.window.show_view(Main_Menu.MyView())
...
class MyView(arcade.View):
    ...
    def __init__(self):
        ...
        self.background = arcade.load_texture(os.path.join('images', 'End_Game.jpg'))
    ...
    def setup(self):
        ...
        # List of music
        self.music_list = [os.path.join('Music', 'scott-buckley-omega.mp3'),
                           os.path.join('Music', 'scott-buckley-machina.mp3')]
        ...
        self.ui_manager.add_ui_element(arcade.gui.UILabel(
            "You have escaped from Moon Base Delta\n\n"
            "      by launching an escape pod! \n\n"
            "You managed to contact the international\n\n"
            " space station and a rescue shuttle has\n\n"
            "     been dispatched to pick you up...",
            center_x=self.left_column_x * 2,
